...
export default function App() {
  ...
  const [loansData, setLoansData] = useState<{ data: Loan[]; pagination: PaginationMeta } | null>(null);
  const [borrowingsData, setBorrowingsData] = useState<{ data: Borrowing[]; pagination: PaginationMeta } | null>(null);
        ...
        <section className="auth-panel">
          <div className="auth-card">
            ...
            <form className="auth-form" onSubmit={authTab === 'login' ? handleLogin : handleRegister}>
              ...
              <div className="social-auth-wrapper" style={{ marginTop: '16px', display: 'flex', flexDirection: 'column', gap: '12px' }}>
                <button 
                  type="button"
                ...
                >
                  ...
                  {authTab === 'login' ? 'Sign in with Google' : 'Sign up with Google'}
                </button>
                <div style={{ display: 'flex', gap: '12px' }}>
                  ...
                  >
                    <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                      <path d="M17.05 20.28c-.98.95-2.05.8-3.08.35-1.09-.46-2.09-.48-3.24 0-1.44.62-2.2.44-3.06-.35C2.79 15.25 3.51 7.59 9.05 7.31c1.35.07 2.29.74 3.08.8 1.18-.19 2.31-.88 3.5-.84 1.5.06 2.65.65 3.34 1.63-2.9 1.76-2.4 5.32.48 6.55-.65 1.76-1.57 3.56-2.4 4.83zM12.03 7.25c-.15-2.23 1.66-4.07 3.74-4.25.29 2.58-2.34 4.5-3.74 4.25z"/>
                    </svg>
                    Apple <small>(Soon)</small>
                  </button>
                  <button 
                    type="button"
                    className="button button-secondary button-full" 
